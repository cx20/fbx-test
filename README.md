...
| [gltf/Fox](assets/models/fbx/gltf/Fox.fbx) | :white_check_mark: [Sample](https://cx20.github.io/fbx-test/example/threejs/index.html?model=gltf/Fox) | :white_check_mark: [Sample](https://cx20.github.io/fbx-test/example/babylonjs/index.html?model=gltf/Fox) | :warning: [Sample](https://cx20.github.io/fbx-test/example/webgl1/index.html?model=gltf/Fox) | Skinned mesh with multiple animation clips (glTF sample). WebGL 1.0: only the first clip plays. |
