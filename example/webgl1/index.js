...
// Orbit-style camera controller: left-drag orbits, right-drag pans, wheel
// zooms. Spherical coords (azimuth, polar, distance) relative to a target
// — the same shape as THREE.OrbitControls and BABYLON.ArcRotateCamera. We
// maintain them next to cameraEye/cameraTarget and rebuild cameraEye every
...
const orbit = (() => {
    ...
    function pan(dx, dy) {
        // Build camera basis (right, up) in world space.
...
function attachCameraControls() {
    ...
    // Basic single-touch orbit (no pinch-zoom yet).
