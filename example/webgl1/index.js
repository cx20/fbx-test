...
function initGL() {
    ...
    skeletonProgram = createProgram(
        'attribute vec3 aPosition; uniform mat4 uViewProj; void main() { gl_Position = uViewProj * vec4(aPosition, 1.0); }',
        'precision mediump float; void main() { gl_FragColor = vec4(1.0, 0.08, 0.04, 1.0); }',
    );
...
// =====================================================================
// GPU upload (renderable mesh from common buildMesh → WebGL buffers)
// =====================================================================
